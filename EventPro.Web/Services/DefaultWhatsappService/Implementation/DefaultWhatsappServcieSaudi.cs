...
namespace EventPro.Web.Services.DefaultWhatsapp.Implementation
{
    ...
    {
        public DefaultWhatsappServcieSaudi(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IBlobStorage blobStorage) : base(configuration, httpContextAccessor, blobStorage)
        {
        }
    }
}
