...
namespace EventPro.Web.Services.DefaultWhatsapp.Implementation
{
    ...
    {
        public DefaultWhatsappServcieBahrain(IConfiguration configuration, IHttpContextAccessor httpContextAccessor, IBlobStorage blobStorage , IHttpClientFactory httpClientFactory) : base(configuration, httpContextAccessor, blobStorage , httpClientFactory)
        {
        }
